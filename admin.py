...
Label(winadmin, text='Fake Logo Detection', bg="#ffb366", font='verdana 15 bold') \
    .place(x=300, y=150)
...
Button(winadmin, text="login", font='Verdana 10 bold', bg="#ff0000", command=act).place(x=340, y=520)
winadmin.mainloop()
