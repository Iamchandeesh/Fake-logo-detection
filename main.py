...
class ViewData:
    def __init__(self):
        ...
        def act2():
            ...
            f_types = [('Jpg Files', '*.jpg'),('Png Files', '*.png')]
            filename1 = filedialog.askopenfilename(filetypes=f_types)
            pathSpecified = "E:\Fakelogodetect\Train_dataset"
            ...
            with Image.open(filename1) as img:
                ...
                print(hash1)
            for image in fnames:
                with Image.open(os.path.join("E:\Fakelogodetect\Train_dataset", image)) as img1:
        ...
        heading = Label(win, text="Fake Logo Detection", font='Verdana 20 bold')
        heading.place(x=510, y=60)
